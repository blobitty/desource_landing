...
const COLUMNS = [
  ...
  "We’re building simulated environments to further the social coordination between people and agents. If our work interests you, please reach out to b@sudosrc.com.",
] as const;
